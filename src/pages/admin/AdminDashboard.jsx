        ...
        <Layout>
            ...
            <div className="px-5">
                ...
                <div className="mid mb-5">
                    {/* main  */}
                    <div className=" bg-violet-50 py-5 rounded-xl border border-violet-100">
                        {/* image  */}
                        ...
                        {/* text  */}
                        <div className="">
                            <h1 className=" text-center text-lg text-violet-500"><span className=" font-bold">Name :</span>{user?.name}</h1>
                            <h1 className=" text-center text-lg text-violet-500"><span className=" font-bold">Email :</span>{user?.email}</h1>
                            {/* Date  */}
                    ...
                    <Tabs>
                        <TabList className="flex flex-wrap -m-4 text-center justify-center">
                            ...
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-violet-50 hover:bg-violet-100 border-violet-100 px-4 py-3 rounded-xl" >
                                    ...
                                    <h2 className="title-font font-medium text-3xl text-violet-400 fonts1" >{getAllProduct.length}</h2>
                            ...
                            <Tab className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-violet-50 hover:bg-violet-100 border-violet-100 px-4 py-3 rounded-xl" >
                                    ...
                                    <h2 className="title-font font-medium text-3xl text-violet-400 fonts1" >{getAllOrder.length}</h2>
